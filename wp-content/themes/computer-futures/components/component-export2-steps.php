        ...
        <ul class="list-group cf-steps-widget">
            <li class="list-group-item d-flex justify-content-between align-items-center">
                ...
                <div class="cf-steps-left">
                    ...
                    <?php if($reviewIdCookie) { ?>
                        <a href="<?php echo get_the_permalink(494); ?>"><?php echo get_the_title($reviewIdCookie); ?></a>
                    <?php } ?>
                </div>
	            <?php if($reviewIdCookie) { ?>
                    <a class="cf-steps-right" href="<?php echo get_the_permalink(494); ?>"><i class="far fa-edit"></i></a>
	            <?php } ?>
            </li>
            ...
            <li class="list-group-item d-flex justify-content-between align-items-center">
                ...
                <div class="cf-steps-left">
                    STEP 2: USERS<br>
	                <?php if($usersCookie) { ?>
                        <a href="<?php echo get_the_permalink(494); ?>/?step=2"><?php echo $userData->data->display_name; ?></a>
	                <?php } ?>
                </div>
	            <?php if($usersCookie) { ?>
                    <a class="cf-steps-right" href="<?php echo get_the_permalink(494); ?>/?step=2"><i class="far fa-edit"></i></a>
	            <?php } ?>
            </li>
            <li class="list-group-item d-flex justify-content-between align-items-center">
	            ...
	            if($compareTypeCookie) {
	                if($compareTypeCookie === 'none') {
	                    ...
	                    $userId = (int)$_COOKIE['export2-compare-user-id'];
                ...
                <div class="cf-steps-left">
                    STEP 3: COMPARE<br>
			        <?php if($compareType) { ?>
                        <a href="<?php echo get_the_permalink(494); ?>/?step=3"><?php echo $compareType; ?></a>
			        <?php } ?>
                </div>
		        <?php if($compareType) { ?>
                    <a class="cf-steps-right" href="<?php echo get_the_permalink(494); ?>/?step=3"><i class="far fa-edit"></i></a>
		        <?php } ?>
            </li>
            <li class="list-group-item d-flex justify-content-between align-items-center">
	            ...
	            $yearFrom = isset( $_COOKIE['export2-year-from'] ) ? $_COOKIE['export2-year-from'] : '';
	            $yearTo = isset( $_COOKIE['export2-year-to'] ) ? $_COOKIE['export2-year-to'] : '';

	            $periodNames = array('First quarter', 'Second quarter', 'Third quarter', 'Fourth quarter'); ?>
                <div class="cf-steps-left">
                    STEP 4: PERIOD<br>
	                <?php if($periodFrom && $periodTo && $yearFrom && $yearTo) { ?>
                        From: <a href="<?php echo get_the_permalink(494); ?>/?step=4"><?php echo $periodNames[$periodFrom - 1] . ' ' . $yearFrom; ?></a><br>
                        To: <a href="<?php echo get_the_permalink(494); ?>/?step=4"><?php echo $periodNames[$periodTo - 1] . ' ' . $yearTo; ?></a>
	                <?php } ?>
                </div>
	            <?php if($periodFrom && $periodTo && $yearFrom && $yearTo) { ?>
                    <a class="cf-steps-right" href="<?php echo get_the_permalink(494); ?>/?step=4"><i class="far fa-edit"></i></a>
	            <?php } ?>
            </li>
        </ul>
