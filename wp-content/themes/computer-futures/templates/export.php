	...
	<div class="container">
		...
		<div class="row">
			<div class="col-md-12 col-lg-8">
				...
				<div class="cf-panel">
					...
					<?php } else { ?>
						...
						<?php if($_GET['step'] == 2 && isset( $_COOKIE['export-review-id'] ) && $_COOKIE['export-review-id']) { ?>
							...
							<div class="cf-panel-b">
								...
								<table id="d-with-search-list" class="display cf-datatable" style="width: 100%;">
									...
									$reviewId = $_COOKIE['export-review-id'];
						...
						<?php if($_GET['step'] == 3 && isset( $_COOKIE['export-user-id'] ) && $_COOKIE['export-user-id']) { ?>
							...
							<div class="cf-panel-b">
								...
								<table id="d-with-search-list" class="display cf-datatable cf-compare-user" style="width: 100%;">
									...
									<tbody>
									<?php $usersCookie = (isset( $_COOKIE['export-compare-user-id'] ) && $_COOKIE['export-compare-user-id'] && $_COOKIE['export-compare-user-id'] !== 'null')
										? $_COOKIE['export-compare-user-id']
										: '';
						...
						<?php if($_GET['step'] == 4) { ?>
							...
							<div class="cf-panel-b">
								...
								$yearFrom = (isset( $_COOKIE['export-year-from'] ) && $_COOKIE['export-year-from']) ? $_COOKIE['export-year-from'] : date('Y');
								$yearTo = (isset( $_COOKIE['export-year-to'] ) && $_COOKIE['export-year-to']) ? $_COOKIE['export-year-to'] : date('Y'); ?>
						...
						<?php if($_GET['step'] == 5) { ?>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="cf-user-info">
                                                    <h5>User info</h5>
                                                    <p>Voornaam: <?php echo $userData->first_name; ?></p>
                                                    <p>Achternaam: <?php if($middleName) echo $middleName . ' '; echo $userData->last_name; ?></p>
                                                    <p>E-mailadres: <?php echo $userData->user_email; ?></p>
                                            ...
                                            <?php if($compareType === 'users'): ?>
                                                <div class="col-md-6">
                                                    <div class="cf-user-info">
                                                        ...
                                                        <p>Voornaam: <?php echo $userDataCompare->first_name; ?></p>
                                                        <p>Achternaam: <?php if($compareMiddleName) echo $compareMiddleName . ' '; echo $userDataCompare->last_name; ?></p>
                                                        <p>E-mailadres: <?php echo $userDataCompare->user_email; ?></p>
                                                        <p>Sector: <?php echo $compareSector; ?></p>
                                                    </div>
                                                </div>
                                            <?php endif; ?>
                                        </div>
                            ...
                            <script>
                                jQuery(document).ready(function($) {
                                    $(".cf-submit-export-pdf").on("click", function() {
			...
			<div class="col-md-12 col-lg-4">
				<?php get_template_part( 'components/component', 'export-steps' ); ?>
			</div>
		</div>
	</div>
</main>
...
<script>
    jQuery(document).ready(function($) {
        ...
        $("#cf-review-start-s1").on('click', function() {
            ...
            if(selectedReviewId) {
                $.cookie("export-review-id", selectedReviewId, {path: '/'});
                window.location.href = "<?php echo get_the_permalink(25); ?>/?step=2";
            } else {
        ...
        $("#cf-review-start-s2").on('click', function() {
            ...
            if(selectedUsersId) {
                $.cookie("export-user-id", selectedUsersId, {path: '/'});
                window.location.href = "<?php echo get_the_permalink(25); ?>/?step=3";
            } else {
        ...
        $("#cf-review-start-s3").on('click', function() {
            ...
            $.cookie("export-compare-type", selectedCompareType, {path: '/'});
            if(selectedCompareType !== 'users') {
                $.cookie("export-compare-user-id", '', {path: '/'});
                window.location.href = "<?php echo get_the_permalink(25); ?>/?step=4";
            } else if(selectedUsersId) {
                $.cookie("export-compare-user-id", selectedUsersId, {path: '/'});
                window.location.href = "<?php echo get_the_permalink(25); ?>/?step=4";
            }
        });
        ...
        $("#cf-review-start-s4").on('click', function() {
            ...
            if(periodFrom && periodTo && yearFrom && yearTo) {
                $.cookie("export-period-from", periodFrom, {path: '/'});
                $.cookie("export-period-to", periodTo, {path: '/'});
                $.cookie("export-year-from", yearFrom, {path: '/'});
                $.cookie("export-year-to", yearTo, {path: '/'});
                window.location.href = "<?php echo get_the_permalink(25); ?>/?step=5";
            } else {
