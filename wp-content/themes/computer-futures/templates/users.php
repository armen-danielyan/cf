		...
		<div class="row">
			<div class="col-md-12">
				<div class="p-4">
					...
					<a class="cf-blue-btn" href="<?php echo get_the_permalink(80); ?>"><i class="fas fa-plus" style="margin-right: 10px"></i> NEW USER</a>
				</div>
			</div>
		</div>
					...
					<div class="cf-panel-b">
						<table id="d-with-search-list" class="display cf-datatable" style="width: 100%;">
							...
							foreach ($users->get_results() as $user) {
                                $userId = $user->data->ID;
                                $archived = get_user_meta($userId, '_cf_user_archive', true);
